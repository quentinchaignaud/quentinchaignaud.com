...
<svelte:head>
	...
	<meta name="description" content="Software engineer travaillant principalement avec Python et SQL." />
	<meta property="og:title" content="Quentin Chaignaud | Software Engineer" />
	<meta property="og:description" content="Software engineer travaillant principalement avec Python et SQL." />
	...
	<meta name="twitter:description" content="Software engineer travaillant principalement avec Python et SQL." />
  ...
  <div class="relative px-6 lg:px-8 min-h-screen">
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32">
      <div class="text-center">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">Je suis un développeur fullstack spécialisé en Python et SQL. Je m'intéresse aussi au développement Web et Mobile, ainsi qu'aux systèmes distribués.</p>
