  ...
  <div class="relative px-6 lg:px-8 min-h-screen">
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32">
      <div class="text-center">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">Je suis un software engineer spécialisé en Python et Azure. Je donne aussi des cours d'informatique en ligne.</p>
