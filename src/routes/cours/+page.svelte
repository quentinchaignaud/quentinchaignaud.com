        ...
        <div class="mt-16 space-y-20 lg:mt-20 lg:space-y-20">
          <article class="relative isolate flex flex-col gap-8 lg:flex-row lg:hover:bg-gray-100 p-4 rounded-xl hover:cursor-pointer dark:lg:hover:bg-gray-800">
            <div class="relative aspect-[16/9] sm:aspect-[2/1] lg:aspect-square lg:w-64 lg:shrink-0">
              <img src={imgData} alt="Vieil ordinateur IBM et du matos autour, ambiance rétro des années 80 avec néon, et une icône d'éclair blanc au centre." class="absolute inset-0 h-full w-full rounded-2xl bg-gray-50 object-cover">
              ...
              <div class="group relative max-w-xl">
                <div class="lg:mt-3 flex items-center justify-between">
                    <h3 class="text-xl font-semibold leading-6 text-gray-900 dark:text-white">
                      <a href="/cours/voyage-vers-les-donnees">
                ...
                <div class="mt-5 text-sm leading-6 text-gray-600 dark:text-gray-300">
                  Ce cours offre les connaissances nécessaires pour approcher la plupart des problèmes rencontrés dans les systèmes de gestion de données. Il s'agit d'une formation complète, qui vous donnera des fondations solides.
                  A la fin de ce cours, vous saurez :                    
                    <ul class="mt-2 max-w-xl space-y-2">
                      <li class="flex gap-x-2 justify-start">
                        ...
                        <span>Répondre correctement aux questions techniques d'entretien</span>
                      </li>
                        <li class="flex gap-x-2 justify-start">
                          <svg class="mt-0.5 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
                          </svg>
                          <span>Faire évoluer une application web de 0 à 10 millions d’utilisateurs</span>
                        </li>
                        <li class="flex gap-x-2 justify-start">
                          <svg class="mt-0.5 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
                          </svg>
                          <span>Choisir les bases de données les plus adaptées à un projet</span>
                        </li>
                    </ul>
                </div>
              </div>
