...
<div class="py-24 sm:py-32 min-h-screen">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:max-w-4xl">
        ...
        <p class="mt-2 text-base leading-8 text-gray-600 dark:text-gray-300">Tout les cours présents ici sont disponibles gratuitement sur YouTube. Cette plateforme est conçue comme un complément avec des quiz pour chaque valider vos connaissances, des fiches mémos, des exemples de codes, etc.</p>
                ...
                <div class="mt-5 text-sm leading-6 text-gray-600 dark:text-gray-300">
                    ...
                    <ul class="mt-2 max-w-xl space-y-2">
                        <li class="flex gap-x-2 items-center">
                          ...
                          <span>Le binaire</span>
                        </li>
                        <li class="flex gap-x-2 items-center">
                          <svg class="h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
                          </svg>
                          <span>Les portes logiques</span>
                        </li>
                        <li class="flex gap-x-2 items-center">
                          <svg class="h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
