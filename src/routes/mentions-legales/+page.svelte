...
<div class="py-32 px-6 lg:px-8">
    <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
      ...
      <div class="mt-10 max-w-2xl dark:text-gray-300">
        ...
        <p class="mt-6">Le site {nomDuSite} peut contenir des liens vers d'autres sites web qui ne sont pas sous le contrôle de Quentin Chaignaud. Quentin Chaignaud ne peut être tenu responsable du contenu de ces sites et de l'utilisation qui pourrait en être faite.</p>
