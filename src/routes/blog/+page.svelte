    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl">
        <div class="mx-auto max-w-2xl text-center">
          ...
          <p class="mt-2 text-sm md:text-base leading-8 text-gray-600 dark:text-gray-300">Un petit blog perso qui parle principalement de tech, mais aussi de plein d'autres choses que je trouve intéressantes.</p>
        </div>
