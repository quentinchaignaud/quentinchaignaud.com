<div class="py-32 px-6 lg:px-8">
    <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700 dark:text-gray-300">
      <p class="text-base font-semibold leading-7 text-indigo-600 dark:text-indigo-400">Introducing</p>
      <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white">JavaScript for Beginners</h1>
      <p class="mt-6 text-xl leading-8 dark:text-gray-300">Aliquet nec orci mattis amet quisque ullamcorper neque, nibh sem. At arcu, sit dui mi, nibh dui, diam eget aliquam. Quisque id at vitae feugiat egestas ac. Diam nulla orci at in viverra scelerisque eget. Eleifend egestas fringilla sapien.</p>
      <div class="mt-10 max-w-2xl">
        <p>Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus enim. Mattis mauris semper sed amet vitae sed turpis id. Id dolor praesent donec est. Odio penatibus risus viverra tellus varius sit neque erat velit. Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus enim. Mattis mauris semper sed amet vitae sed turpis id.</p>
        <ul class="mt-8 max-w-xl space-y-8 text-gray-600 dark:text-gray-300">
        ...
        <h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">From beginner to expert in 3 hours</h2>
        ...
        <figure class="mt-10 border-l border-indigo-600 pl-9">
          ...
          <figcaption class="mt-6 flex gap-x-4">
            ...
            <div class="text-sm leading-6"><strong class="font-semibold text-gray-900 dark:text-white">Maria Hill</strong> – Marketing Manager</div>
          </figcaption>
        </figure>
      ...
      <div class="mt-16 max-w-2xl">
        <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Everything you need to get up and running</h2>
