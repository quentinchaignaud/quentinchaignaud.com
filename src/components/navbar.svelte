...
<header>
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="/meilleures-ressources" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">Meilleures ressources</a>
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <a on:click={() => (showMenuMobile = !showMenuMobile) } href="/meilleures-ressources" class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:text-white  dark:hover:bg-gray-800">Blog</a>
